// Encrypting and decrypting plain text messagescontaining alphabets using their ASCII
// value, m="This is Computing Lab-1".
...
int main() {
    primefiller();
    setkeys();
    string message = "This is Computing Lab-1";
